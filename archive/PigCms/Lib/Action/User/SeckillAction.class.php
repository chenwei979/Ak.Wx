	...
	public function shop_add()
	{
		...
		if (IS_POST) {
			...
			if (isset($_POST['sid']) && !empty($_POST['sid'])) {
				$shop_big = trim(implode($_POST['shop_big'], ';'), ';');

				if ($shop_big == '') {
					$this->error('至少有商品展示图片');
				}

				$data1 = array('shop_id' => $_POST['sid'], 'action_id' => $_POST['aid'], 'shop_name' => $_POST['shop_name'], 'shop_num' => $_POST['shop_num'], 'shop_price' => $_POST['shop_price'], 'shop_tran' => $_POST['shop_tran'], 'shop_open' => $_POST['shop_open'], 'shop_detail' => $_POST['shop_detail'], 'shop_img' => $shop_big);
